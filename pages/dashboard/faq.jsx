...
const faqConfig = [
        ...
        {
            q:'Where can I find additional information about the product?',
        ...
        {
            q:'Can I change my contact information and shipping address?',
        ...
        {
            q:'What are the content and post guidelines?',
            a:'You can find all post and content guidelines on our How to Craft the Perfect Post page. '
        },
        {
            q:'Are my post’s supposed to follow the FTC guidelines?',
            a:'Yes, all posts should follow FTC guidelines.'
        },
        {
            q:'Is there an expiry date for my promo code?',
