        ...
        <DashboardContainer title={"Crafting the perfect post"}>
         <PageBanner title={"CRAFTING THE PERFECT POST"} height={500}  bgSrc={"/dashboard/perfect_post.png"} />
            <div className="bg-dark text-white">
                ...
                <section className="perfectpartdiv">
                    <div className="container">
                        <div className="row">
            ...
            <div>
            <section className="alittlepart">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <h2 className="alittle"><strong>A Little More In-Depth</strong></h2>
            ...
            <div className={"bg-white"} style={{marginTop: '-1.5rem'}}>
                <section className={"blueperefect"} style={{backgroundColor: "#0079C0"}}>
                    <div className="container text-light">
                        <div className="row">
                            <div className={"col-lg-12 promodcode"}>
                                <h3><strong>Promo-codes</strong></h3>
                            ...
                            <div className={"col-lg-12 promodcode"}>
                                <h3><strong>Trackable Links</strong></h3>
                ...
                <section className="blueperefect last text-light" style={{backgroundColor: "#0079C0"}}>
                    <div className="container">
                        <div className="row">
                            <div className={"col-lg-12 promodcode"}>
                                <h3><strong>How to Add Links to Your Instagram Stories</strong></h3>
                            </div>
                            <div className={"col-lg-12"}>
                ...
                <div className="bg-white text-dark">
                    <section className={"avideostory"}>
                        <div className="container">
                            <div className="row postingavid">
                                <div className="col-lg-12">
                                    <h2><strong>Posting a Video Vs. Story</strong></h2>
                                </div>
                            </div>
                ...
                <div className={"oncepartbg bg-dark"}>
                    <section className={"container"}>
                        <div className="row">
                            <div className="oncethat col-lg-12">
...
function Point({number, children}){
    return <div className={"d-flex align-items-center numberlist"}>
...
function Card({src, title, Icon, description, noBorder}){
    return  <div className={`col-lg-3 col-md-6 col-6 text-dark text-center`}>
        <div className="text-center p-4 iconimgperfect">
