...
function PageBanner({title, desc, bgSrc, height}) {
    return (
        <div>
            <div className="pagebannerto" style={{height, background: `${title || desc ? 'linear-gradient(0deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), ' : ''} url(${bgSrc}) no-repeat center center`, backgroundSize:'cover'}}>
